 ...
 */
final class Version20211016125246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD color_id INT DEFAULT NULL, ADD taille DOUBLE PRECISION NOT NULL, ADD vase VARCHAR(255) NOT NULL, ADD tuyau VARCHAR(255) NOT NULL, ADD fixation VARCHAR(255) NOT NULL, ADD autre VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP color_id, DROP taille, DROP vase, DROP tuyau, DROP fixation, DROP autre');
    }
}
